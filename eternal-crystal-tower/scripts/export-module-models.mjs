...
for(const id of Object.keys(MODULES)) {
  const model={parts:[{name:id,vertices:buildModuleMesh(meshBuilder,{id,level:1})}]};
  const json={asset:{version:'2.0',generator:'CrystalTower mesh exporter'},scene:0,
    scenes:[{nodes:[0]}],nodes:[{name:MODULES[id].name,mesh:0,scale:[.01,.01,.01]}],
